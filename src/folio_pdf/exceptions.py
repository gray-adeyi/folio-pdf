...
class GridException(FolioPDFException): ...


class ColumnsException(FolioPDFException): ...


class FormException(FolioPDFException): ...


class FormFieldException(FolioPDFException): ...


class FormFillerException(FolioPDFException): ...


class TabbedLineException(FolioPDFException): ...
